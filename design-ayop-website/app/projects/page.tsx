    ...
    <>
      ...
      <main>
        ...
        <section className="pt-8 pb-16 md:pt-12 md:pb-24 px-6 md:px-12">
          ...
          >
            Collaborations, activations, and community partnerships. Using movement as the starting point for meaningful exchange.
          </motion.p>
        </section>
                  ...
                  <div>
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <h2 className="mt-1 text-xl font-bold tracking-tight group-hover:text-muted-foreground transition-colors">
                          {project.title}
                        </h2>
