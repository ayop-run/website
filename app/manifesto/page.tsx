      ...
      <main>
          ...
          <div className="max-w-4xl mx-auto">
            {manifestoLines.map((line, i) => (
              <motion.p
                ...
                className={`type-quote mb-2 ${
                  line.highlight ? 'text-foreground font-bold' : 'text-muted-foreground'
                }`}
              >
                {line.text}
              </motion.p>
          ...
          <div className="max-w-4xl mx-auto">
            {manifestoLines2.map((line, i) => (
              <motion.p
                ...
                viewport={{ once: true, margin: '-50px' }}
                transition={{ duration: 0.5, delay: i * 0.1 }}
                className="type-h3 text-foreground mb-4 last:mb-0"
              >
                {line}
              </motion.p>
            ))}
          ...
          <div className="max-w-3xl mx-auto text-center">
            {manifestoLines3.map((line, i) => (
              <motion.p
                ...
                viewport={{ once: true, margin: '-50px' }}
                transition={{ duration: 0.5, delay: i * 0.1 }}
                className="type-quote text-muted-foreground font-bold"
              >
                {line}
              </motion.p>
            ))}
          ...
          <div className="max-w-3xl mx-auto text-center">
            {manifestoLines4.map((line, i) => (
              <motion.p
                ...
                viewport={{ once: true, margin: '-50px' }}
                transition={{ duration: 0.5, delay: i * 0.1 }}
                className="type-quote text-foreground font-bold"
              >
                {line}
              </motion.p>
            ))}
          ...
          <div className="max-w-4xl mx-auto text-center">
            {manifestoLines5.map((line, i) => (
              <motion.p
                ...
                viewport={{ once: true, margin: '-50px' }}
                transition={{ duration: 0.5, delay: i * 0.1 }}
                className="type-display text-[clamp(2rem,5vw,4rem)]"
              >
                {line}
              </motion.p>
            ))}
        ...
        <section className="py-16 md:py-24 border-t border-border bg-card">
          <div className="px-6 md:px-12">
            ...
            >
              <h2 className="type-h3 font-bold">Join the movement</h2>
