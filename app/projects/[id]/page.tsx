        ...
        <section className="px-6 md:px-12 pb-16 md:pb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="type-eyebrow mb-4">Overview</h2>
              <p className="type-body">{project.fullDescription}</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <h2 className="type-eyebrow mb-4">Challenge</h2>
              <p className="type-body text-muted-foreground">{project.challenge}</p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="px-6 md:px-12 pb-16 md:pb-24 border-t border-border pt-16 md:pt-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="type-eyebrow mb-4">Approach</h2>
            ...
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.1 }}
            >
              <h2 className="type-eyebrow mb-4">Outcome</h2>
              ...
              .map((otherProject, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <h3 className="mt-2 type-h3 font-bold group-hover:text-muted-foreground transition-colors">
                      {otherProject.title}
                    </h3>
